...
public class Clase02_MatrixCalculator {
    private static final String INPUT_FILE = "src/main/resources/waitExamples/matrices";
    private static final String OUTPUT_FILE = "src/main/resources/waitExamples/matrices_results.txt";
